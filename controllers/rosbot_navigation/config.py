...
SEARCH_ROTATION_SPEED = 0.45
NO_PATH_ROTATION_SPEED = 0.65
VISUAL_APPROACH_FAST_MPS = 0.35
VISUAL_APPROACH_SLOW_MPS = 0.0
VISUAL_APPROACH_ALIGN_ERROR = 0.40

VISUAL_SERVO_ANGULAR_GAIN = 0.35
...
GREEN_AHEAD_MIN_AREA = 350
GREEN_AHEAD_MIN_Y_FRAC = 0.52
GREEN_AHEAD_MAX_ERROR = 0.72
GREEN_MARK_DISTANCE_M = 0.85

DIRECT_TARGET_MIN_AREA = 180
TARGET_IGNORE_TOP_FRAC = 0.30
PLANNING_WAYPOINT_LOOKAHEAD = 5
PLAN_STALE_SECONDS = 0.8
